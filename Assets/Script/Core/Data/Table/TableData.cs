...
namespace Core.Data
{
    public class TableData
    {
        ...
        public readonly Dictionary<string, UnitConfig> UnitConfigs = new()
        {
            ...
            { "u_enemy_skeleton_01", new() { id = "u_enemy_skeleton_01", characterDataId = "3", spawnPosition = "(1,3,3)", level = 2, faction = Global.FactionType.Enemy, facing = Global.UnitFacing.North, hpBonusPercent = 0.0f, atkBonusPercent = 0.0f, defBonusPercent = 0.0f, resBonusPercent = 0.0f } },
            ...
            { "u_enemy_skeleton_02", new() { id = "u_enemy_skeleton_02", characterDataId = "3", spawnPosition = "(2,3,4)", level = 2, faction = Global.FactionType.Enemy, facing = Global.UnitFacing.North, hpBonusPercent = 0.0f, atkBonusPercent = 0.0f, defBonusPercent = 0.0f, resBonusPercent = 0.0f } },
            ...
            { "u_enemy_skeleton_lv2_01", new() { id = "u_enemy_skeleton_lv2_01", characterDataId = "3", spawnPosition = "(7,3,7)", level = 2, faction = Global.FactionType.Enemy, facing = Global.UnitFacing.North, hpBonusPercent = 0.0f, atkBonusPercent = 0.0f, defBonusPercent = 0.0f, resBonusPercent = 0.0f } },
            { "u_enemy_skeleton_lv2_02", new() { id = "u_enemy_skeleton_lv2_02", characterDataId = "3", spawnPosition = "(6,3,7)", level = 2, faction = Global.FactionType.Enemy, facing = Global.UnitFacing.North, hpBonusPercent = 0.0f, atkBonusPercent = 0.0f, defBonusPercent = 0.0f, resBonusPercent = 0.0f } },
            ...
            { "u_enemy_skeleton_lv3_01", new() { id = "u_enemy_skeleton_lv3_01", characterDataId = "3", spawnPosition = "(1,0,7)", level = 2, faction = Global.FactionType.Enemy, facing = Global.UnitFacing.North, hpBonusPercent = 0.0f, atkBonusPercent = 0.0f, defBonusPercent = 0.0f, resBonusPercent = 0.0f } },
            { "u_enemy_skeleton_lv3_02", new() { id = "u_enemy_skeleton_lv3_02", characterDataId = "3", spawnPosition = "(6,0,7)", level = 2, faction = Global.FactionType.Enemy, facing = Global.UnitFacing.North, hpBonusPercent = 0.0f, atkBonusPercent = 0.0f, defBonusPercent = 0.0f, resBonusPercent = 0.0f } },
