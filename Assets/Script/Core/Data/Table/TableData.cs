...
namespace Core.Data
{
    public class TableData
    {
        ...
        public readonly Dictionary<string, BlockConfig> BlockConfigs = new()
        {
            ...
            { "quartz", new() { id = "quartz", prefabAddress = "Assets/Perfob/block/Block_Quartz.prefab", blockType = Global.BlockType.Solid, isWalkable = true, xCellSize = 1.0f, yCellSize = 1.0f, zCellSize = 1.0f, heightOffset = 0.0f, threatScore = 0, effectEnter = new() {  }, effectExit = new() {  }, effectStay = new() {  } } },
            { "red_concrete", new() { id = "red_concrete", prefabAddress = "Assets/Perfob/block/Block_Red_Concrete.prefab", blockType = Global.BlockType.Solid, isWalkable = true, xCellSize = 1.0f, yCellSize = 1.0f, zCellSize = 1.0f, heightOffset = 0.0f, threatScore = 0, effectEnter = new() {  }, effectExit = new() {  }, effectStay = new() {  } } },
            { "green_concrete", new() { id = "green_concrete", prefabAddress = "Assets/Perfob/block/Block_Green_Concrete.prefab", blockType = Global.BlockType.Solid, isWalkable = true, xCellSize = 1.0f, yCellSize = 1.0f, zCellSize = 1.0f, heightOffset = 0.0f, threatScore = 0, effectEnter = new() {  }, effectExit = new() {  }, effectStay = new() {  } } }
        };
        ...
        public readonly Dictionary<string, LevelConfig> LevelConfigs = new()
        {
            ...
            { "lv_004", new() { id = "lv_004", mapAddress = "Assets/Map/cornell_box.asset", playerDeployZones = new() { "(1,0,1)", "(2,0,1)", "(3,0,1)", "(1,0,2)", "(2,0,2)", "(3,0,2)" }, maxDeployCount = 4, unitIds = new() { "u_enemy_zombie_cornell_01", "u_enemy_zombie_cornell_02" }, fallbackUnitIds = new() { "u_fallback_01" } } }
        };
        ...
        public readonly Dictionary<string, UnitConfig> UnitConfigs = new()
        {
            ...
            { "u_enemy_zombie_cornell_01", new() { id = "u_enemy_zombie_cornell_01", characterDataId = "2", spawnPosition = "(4,0,5)", level = 0, faction = Global.FactionType.Enemy, facing = Global.UnitFacing.North, hpBonusPercent = 0.0f, atkBonusPercent = 0.0f, defBonusPercent = 0.0f, resBonusPercent = 0.0f } },
            { "u_enemy_zombie_cornell_02", new() { id = "u_enemy_zombie_cornell_02", characterDataId = "2", spawnPosition = "(5,0,6)", level = 0, faction = Global.FactionType.Enemy, facing = Global.UnitFacing.North, hpBonusPercent = 0.0f, atkBonusPercent = 0.0f, defBonusPercent = 0.0f, resBonusPercent = 0.0f } },
