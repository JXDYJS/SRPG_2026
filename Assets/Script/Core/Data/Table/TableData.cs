...
namespace Core.Data
{
    public class TableData
    {
        ...
        public readonly Dictionary<string, RelicConfig> RelicConfigs = new()
        {
            ...
            { "r_shield", new() { id = "r_shield", name = "Iron Shield", desc = "Legend says this shield once blocked a Creeper's full blast and remains intact. Reduce all damage taken by 2.", rarity = Global.RarityType.Common, minPrice = 40, maxPrice = 70, sprite = "Assets/textures/entity/shield/base.png" } },
