namespace Core.Data
{
    public class EventConfigData
    {
        ...
        {
            public readonly float speed = 30.0f;
            public readonly float spacing = 100f;        // 管柱水平间距
            ...
            // ================== 鸟物理 ==================
            public readonly float gravity = 1800f;       // 重力加速度 px/s²
            public readonly float flapVel = 480f;        // 点击累加的上升速度 px/s
